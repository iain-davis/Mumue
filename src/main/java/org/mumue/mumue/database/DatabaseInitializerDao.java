...
public class DatabaseInitializerDao {
    ...
    private static final String CHECK_CONFIGURATION_TABLE_VERSION = "select setting from configuration_options where name = '" + OnlineConfigurationOptionName.SERVER_VERSION + "'";
