...
create table players(loginId varchar(255) primary key, password varchar(255));
...
create table components(id int primary key auto_increment, name varchar(255),
                        description varchar(255), created timestamp, lastUsed timestamp, lastModified timestamp,
                        useCount long, universeId int, locationId int);
