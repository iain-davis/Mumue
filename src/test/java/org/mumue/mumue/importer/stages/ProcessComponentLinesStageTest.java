...
public class ProcessComponentLinesStageTest {
    ...
    public void generateShouldSetLocation() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
        Space location = new Space().withId(RandomUtils.insecure().randomLong(100, 200));
    ...
    public void generateShouldSetFirstContents() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
        Artifact artifact = new Artifact().withId(RandomUtils.insecure().randomLong(200, 300));
        ImportBucket bucket = setupTest(space, artifact);
        stage.run(bucket);
        Assert.assertEquals(artifact.getId(), bucket.getComponents().get(space.getId()).getContents().get(0).getId());
    }

    @Test
    public void generateShouldSetCreated() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
        Long created = RandomUtils.insecure().randomLong(100000, 200000);
    ...
    public void generateShouldSetLastUsed() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
        Long lastUsed = RandomUtils.insecure().randomLong(100000, 200000);
    ...
    public void generateShouldSetModified() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
        Long lastModified = RandomUtils.insecure().randomLong(100000, 200000);
    ...
    public void generateWithArtifactShouldSetHome() {
        Artifact artifact = new Artifact().withId(RandomUtils.insecure().randomLong(300, 400));
        Space home = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    public void generateWithArtifactShouldSetOwner() {
        Artifact artifact = new Artifact().withId(RandomUtils.insecure().randomLong(300, 400));
        GameCharacter owner = new GameCharacter().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    public void generateWithArtifactShouldSetValue() {
        Long value = RandomUtils.insecure().randomLong(100, 1000);
        Artifact artifact = new Artifact().withId(RandomUtils.insecure().randomLong(300, 400));
    ...
    public void generateWithCharacterShouldSetHome() {
        GameCharacter character = new GameCharacter().withId(RandomUtils.insecure().randomLong(300, 400));
        Space home = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    public void generateWithLinkShouldSetOwner() {
        Link link = new Link().withId(RandomUtils.insecure().randomLong(300, 400));
        GameCharacter owner = new GameCharacter().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    public void generateWithProgramShouldSetOwner() {
        Program program = new Program().withId(RandomUtils.insecure().randomLong(300, 400));
        GameCharacter owner = new GameCharacter().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    public void generateWithSpaceShouldSetDropTo() {
        Space space = new Space().withId(RandomUtils.insecure().randomLong(300, 400));
        Space dropTo = new Space().withId(RandomUtils.insecure().randomLong(2, 100));
    ...
    private ImportBucket setupTest(Artifact artifact, Space home, Link firstLink, GameCharacter owner, Long value) {
        ImportBucket bucket = setupTest(artifact, RandomStringUtils.insecure().nextAlphabetic(13), "1 0",
                                        new Space().withId(RandomUtils.insecure().randomLong(100, 200)),
                                        new Artifact().withId(RandomUtils.insecure().randomLong(200, 300)),
                                        "0 0", 0L, 0L, 0, 0L, new ArrayList<>());
        if (home == null) {
            home = new Space().withId(RandomUtils.insecure().randomLong(600, 700));
        }
        if (owner == null) {
            owner = new GameCharacter().withId(RandomUtils.insecure().randomLong(500, 600));
        }
    ...
    private ImportBucket setupTest(Component component, String name, String description) {
        ImportBucket bucket = setupTest(component, name, description, new Space().withId(RandomUtils.insecure().randomLong(100, 200)),
                new Artifact().withId(RandomUtils.insecure().randomLong(200, 300)), "0 0", 0L, 0L, 0, 0L, new ArrayList<>());
        List<String> lines = bucket.getComponentLines().get(component.getId());
        lines.add("-1");
        lines.add("-1");
        setupTargetComponent(bucket, lines, new GameCharacter().withId(RandomUtils.insecure().randomLong(500, 600)));
        return bucket;
    }
    ...
    private ImportBucket setupTest(Component component, List<String> properties) {
        ImportBucket bucket = setupTest(component, RandomStringUtils.insecure().nextAlphabetic(13), "", new Space().withId(RandomUtils.insecure().randomLong(100, 200)),
                new Artifact().withId(RandomUtils.insecure().randomLong(200, 300)), "0 0", 0L, 0L, 0, 0L, properties);
        List<String> lines = bucket.getComponentLines().get(component.getId());
        lines.add("-1");
        lines.add("-1");
        setupTargetComponent(bucket, lines, new GameCharacter().withId(RandomUtils.insecure().randomLong(500, 600)));
    ...
    private ImportBucket setupTest(Component component, Integer useCount) {
        ImportBucket bucket = setupTest(component, RandomStringUtils.insecure().nextAlphabetic(13), "", new Space().withId(RandomUtils.insecure().randomLong(100, 200)),
                new Artifact().withId(RandomUtils.insecure().randomLong(200, 300)), "0 0", 0L, 0L, useCount, 0L, new ArrayList<>());
        List<String> lines = bucket.getComponentLines().get(component.getId());
        lines.add("-1");
        lines.add("-1");
        setupTargetComponent(bucket, lines, new GameCharacter().withId(RandomUtils.insecure().randomLong(500, 600)));
    ...
    private ImportBucket setupTest(Component component, Long created, Long lastUsed, Long lastModified) {
        ImportBucket bucket = setupTest(component, RandomStringUtils.insecure().nextAlphabetic(13), "", new Space().withId(RandomUtils.insecure().randomLong(100, 200)),
                new Artifact().withId(RandomUtils.insecure().randomLong(200, 300)), "0 0", created, lastUsed, 0, lastModified,
                new ArrayList<>());
        List<String> lines = bucket.getComponentLines().get(component.getId());
        lines.add("-1");
        lines.add("-1");
    ...
    private ImportBucket setupTest(Space space, Artifact firstContent) {
        ImportBucket bucket = setupTest(space, RandomStringUtils.insecure().nextAlphabetic(13), "",
                new Space().withId(RandomUtils.insecure().randomLong(100, 200)),  firstContent, "0 0", 0L, 0L, 0, 0L,
                new ArrayList<>());
        List<String> lines = bucket.getComponentLines().get(space.getId());
        lines.add("-1");
        lines.add("-1");
